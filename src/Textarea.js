...
var Textarea = React.createClass({
    ...
    render: function() {
        let formClasses = classNames('form-group', 'schema-form-textarea', { 'has-error' : this.state.valid === false }, this.props.form.htmlClass, { 'has-success' : this.state.valid === true && this.state.value != null});
