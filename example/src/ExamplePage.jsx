    ...
    constructor(props) {
        ...
        this.state = {
            tests : [
                ...
                {label : "Structured - Closed Object", value: "data/structured/closed-object.json"},
                {label : "Structured - Open Object", value: "data/structured/open-object.json"},
                {label : "Structured - Primitive Array", value: "data/structured/primitive-array.json"},
                {label : "Structured - Object Array", value: "data/structured/object-array.json"},
                {label : "Structured - Invalid Draft", value: "data/structured/invalid-draft.json"},
                {label : "Structured - Read Only", value: "data/structured/read-only.json"},
