...
function _find(items, key) { for (var i = 0; i < items.length; i++) { if (items[i].value === key) { return items[i].value; } } return ""; }
...
var Select = (function (_React$Component) {
    ...
    function Select(props) {
        ...
        this.state = {
            currentValue: this.props.form.titleMap != null ? _find(this.props.form.titleMap, this.props.value) : ""
        };
    }
    ...
    _createClass(Select, [{
        ...
        value: function render() {
            var menuItems = this.props.form.titleMap.map(function (item, idx) {
                return _react2['default'].createElement(_materialUiLibMenusMenuItem2['default'], { key: idx,
