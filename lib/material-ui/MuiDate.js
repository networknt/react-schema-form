...
var MuiDate = (function (_React$Component) {
    _inherits(MuiDate, _React$Component);

    function MuiDate(props) {
        _classCallCheck(this, MuiDate);

        _get(Object.getPrototypeOf(MuiDate.prototype), 'constructor', this).call(this, props);
    }

    _createClass(MuiDate, [{
        key: 'onDatePicked',
...
exports['default'] = (0, _ValidationMixin2['default'])(MuiDate);
