...
var MuiRadios = (function (_React$Component) {
    _inherits(MuiRadios, _React$Component);

    function MuiRadios() {
        _classCallCheck(this, MuiRadios);

        _get(Object.getPrototypeOf(MuiRadios.prototype), 'constructor', this).apply(this, arguments);
    }

    _createClass(MuiRadios, [{
        key: 'render',
...
exports['default'] = (0, _ValidationMixin2['default'])(MuiRadios);
