...
var _MuiStyleCss = require('./MuiStyle.css');

var _MuiStyleCss2 = _interopRequireDefault(_MuiStyleCss);
    ...
    _createClass(MuiSchemaForm, [{
        ...
        value: function render() {
            ...
            return _react2['default'].createElement(
                'div',
                { style: { width: '100%' }, className: _MuiStyleCss2['default'].muiSchemaForm },
                forms
            );
        }
    }], [{
        ...
        value: function renderSchema(form, model, index, onChange) {
            ...
            switch (form.type) {
                case 'number':
                    ...
                    break;
                case 'text':
                    result = _react2['default'].createElement(_MuiText2['default'], { model: model, form: form, key: index, onChange: onChange, className: _MuiStyleCss2['default'].muiSchemaForm });
                    break;
                case 'textarea':
