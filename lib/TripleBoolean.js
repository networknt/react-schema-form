        ...
        value: function displaySwitch() {
            ...
            renderBlock = _react2.default.createElement(
                ...
                this.props.value === 'yes' || this.props.value === 'no' ? _react2.default.createElement(
                    _core.Button,
                    { id: 'temp', variant: 'flat', color: 'primary',
...
(function () {
    ...
    reactHotLoader.register(TripleBoolean, 'TripleBoolean', 'src/TripleBoolean.js');
    reactHotLoader.register(_default, 'default', 'src/TripleBoolean.js');
    leaveModule(module);
})();
