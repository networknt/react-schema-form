...
var SchemaForm = function (_React$Component) {
    ...
    _createClass(SchemaForm, [{
        ...
        value: function __setDefault__REACT_HOT_LOADER__(key, model, form, value) {
            ...
            // If exist a default, and current value is not setted or the field
            // enforces the onDefaultApplyChange apply the default over the model
            if (!_lodash2.default.isNil(value) && (_lodash2.default.isNil(currentValue) || form.onDefaultApplyChange)) this.props.onModelChange(key, value, form.type, form);
        }
    }, {
        key: 'builder',
