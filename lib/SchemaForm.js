...
var SchemaForm = function (_React$Component) {
    ...
    _createClass(SchemaForm, [{
        key: 'builder',
        value: function builder(form, model, index, onChange, mapper, errors) {
            var type = form.type;
            ...
            return _react2.default.createElement(Field, { model: model, form: form, key: key, onChange: onChange, mapper: mapper, builder: this.builder, errorText: error });
        }
    }, {
        key: 'render',
