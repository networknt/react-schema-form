...
var SchemaForm = (function (_React$Component) {
    ...
    _createClass(SchemaForm, [{
        ...
        key: 'builder',
        value: function builder(form, model, index, onChange) {
            var result;
            ...
            switch (form.type) {
                ...
                case 'textarea':
                    ...
                    break;
                case 'select':
                    result = _react2['default'].createElement(_Select2['default'], { model: model, form: form, key: index, onChange: onChange });
                    break;
                case 'radios':
                    result = _react2['default'].createElement(_Radios2['default'], { model: model, form: form, key: index, onChange: onChange });
                    break;
                case 'date':
                    result = _react2['default'].createElement(_Date2['default'], { model: model, form: form, key: index, onChange: onChange });
                    break;
                case 'checkbox':
                    result = _react2['default'].createElement(_Checkbox2['default'], { model: model, form: form, key: index, onChange: onChange });
                    break;
                case 'help':
                    result = _react2['default'].createElement(_Help2['default'], { model: model, form: form, key: index, onChange: onChange });
                    break;
                case 'array':
                    // TODO potentially, this can be rendered as multiple select if items are strings.
                    result = _react2['default'].createElement(_Array2['default'], { model: model, form: form, key: index, onChange: onChange, builder: this.builder });
                    break;
                case 'fieldset':
                    result = _react2['default'].createElement(_FieldSet2['default'], { model: model, form: form, key: index, onChange: onChange, builder: this.builder });
                    break;
            }
            return result;
        }
