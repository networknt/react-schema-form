...
var SchemaForm = function (_React$Component) {
    ...
    function SchemaForm(props) {
        ...
        _this.setDefault = function (key, model, form, value) {
            ...
            if ((0, _isNil2.default)(currentValue) && !(0, _isNil2.default)(value)) _this.props.onModelChange(key, value, form.type, form);
        };
...
(function () {
    ...
    reactHotLoader.register(SchemaForm, 'SchemaForm', 'src/SchemaForm.js');
    leaveModule(module);
})();
