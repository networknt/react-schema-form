...
(function () {
    ...
    reactHotLoader.register(safeEval, 'safeEval', 'src/utils.js');
    reactHotLoader.register(stripNullType, 'stripNullType', 'src/utils.js');
    reactHotLoader.register(enumToTitleMap, 'enumToTitleMap', 'src/utils.js');
    reactHotLoader.register(canonicalTitleMap, 'canonicalTitleMap', 'src/utils.js');
    reactHotLoader.register(stdFormObj, 'stdFormObj', 'src/utils.js');
    reactHotLoader.register(tBoolean, 'tBoolean', 'src/utils.js');
    reactHotLoader.register(text, 'text', 'src/utils.js');
    reactHotLoader.register(number, 'number', 'src/utils.js');
    reactHotLoader.register(integer, 'integer', 'src/utils.js');
    reactHotLoader.register(date, 'date', 'src/utils.js');
    reactHotLoader.register(checkbox, 'checkbox', 'src/utils.js');
    reactHotLoader.register(select, 'select', 'src/utils.js');
    reactHotLoader.register(checkboxes, 'checkboxes', 'src/utils.js');
    reactHotLoader.register(fieldset, 'fieldset', 'src/utils.js');
    reactHotLoader.register(array, 'array', 'src/utils.js');
    reactHotLoader.register(defaults, 'defaults', 'src/utils.js');
    reactHotLoader.register(defaultFormDefinition, 'defaultFormDefinition', 'src/utils.js');
    reactHotLoader.register(getDefaults, 'getDefaults', 'src/utils.js');
    reactHotLoader.register(postProcessFn, 'postProcessFn', 'src/utils.js');
    reactHotLoader.register(appendRule, 'appendRule', 'src/utils.js');
    reactHotLoader.register(prependRule, 'prependRule', 'src/utils.js');
    reactHotLoader.register(traverseSchema, 'traverseSchema', 'src/utils.js');
    reactHotLoader.register(traverseForm, 'traverseForm', 'src/utils.js');
    reactHotLoader.register(merge, 'merge', 'src/utils.js');
    reactHotLoader.register(selectOrSet, 'selectOrSet', 'src/utils.js');
    reactHotLoader.register(validateBySchema, 'validateBySchema', 'src/utils.js');
    reactHotLoader.register(validate, 'validate', 'src/utils.js');
    leaveModule(module);
})();
