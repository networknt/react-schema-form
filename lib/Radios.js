...
var Radios = function (_React$Component) {
  ...
  _createClass(Radios, [{
    ...
    value: function render() {
      ...
      var items = this.props.form.titleMap.map(function (_ref, i) {
        var name = _ref.name,
            value = _ref.value;
        return _react2.default.createElement(_RadioButton2.default, { label: name,
          value: value,
          key: 'react-schema-form-radio-' + _this2.props.form.title + '-' + i,
