...
var _temp = function () {
    ...
    __REACT_HOT_LOADER__.register(Text, 'Text', 'src/__tests__/ComposedCollection-test.js');

    __REACT_HOT_LOADER__.register(Composed, 'Composed', 'src/__tests__/ComposedCollection-test.js');
}();
