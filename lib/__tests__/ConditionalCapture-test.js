...
describe("Composed component test", function () {
    it("The simple condition :", function () {
        var display = (0, _enzyme.render)(_react2.default.createElement(_SchemaForm2.default, { form: cfg.form, schema: cfg.schema, model: cfg.model }));
    ...
    it("The complex condition :", function () {
        ...
        var display = (0, _enzyme.render)(_react2.default.createElement(_SchemaForm2.default, { form: newForm, schema: cfg.schema, model: model }));
        // this case expected to have addictional date input
        expect(display.find("input").length).toEqual(2);

        model = { name: "value" };
        display = (0, _enzyme.render)(_react2.default.createElement(_SchemaForm2.default, { form: newForm, schema: cfg.schema, model: model }));
        // and this one too
        expect(display.find("input").length).toEqual(2);
