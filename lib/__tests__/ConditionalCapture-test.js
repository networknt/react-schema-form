...
describe("Composed component test", function () {
  it("The simple condition :", function () {
    var display = (0, _enzyme.render)( /*#__PURE__*/_react["default"].createElement(_SchemaForm["default"], {
      form: cfg.form,
      schema: cfg.schema,
      model: cfg.model
  ...
  it("The complex condition :", function () {
    ...
    display = (0, _enzyme.render)( /*#__PURE__*/_react["default"].createElement(_SchemaForm["default"], {
      form: newForm,
      schema: cfg.schema,
      model: model
    })); // and this one too
