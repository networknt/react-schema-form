...
describe('SchemaForm test', function () {
    ...
    it('shows SchemaForm', function () {
        ...
        cfg.model['issues'] = 'no';
        result = (0, _enzyme.render)(_react2.default.createElement(_SchemaForm2.default, {
            form: cfg.form,
            model: cfg.model,
            schema: cfg.schema,
            onModelChange: onModelChange
...
(function () {
    ...
    reactHotLoader.register(onModelChange, 'onModelChange', 'src/__tests__/TripleBoolean-test.js');
    reactHotLoader.register(cfg, 'cfg', 'src/__tests__/TripleBoolean-test.js');
    leaveModule(module);
})();
