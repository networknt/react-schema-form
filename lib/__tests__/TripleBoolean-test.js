...
describe("SchemaForm test", function () {
  it("shows SchemaForm", function () {
    var result = (0, _enzyme.render)( /*#__PURE__*/_react["default"].createElement(_SchemaForm["default"], {
      form: cfg.form,
      model: cfg.model,
      schema: cfg.schema,
    ...
    cfg.model.issues = "no";
    result = (0, _enzyme.render)( /*#__PURE__*/_react["default"].createElement(_SchemaForm["default"], {
      form: cfg.form,
      model: cfg.model,
      schema: cfg.schema,
      onModelChange: onModelChange
